...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.jjjis.cn"];
pub const RS_PUB_KEY: &str = "cBR3R+vf3zhfLAa9fIe42g5+fH6gyfIPr3aeBCYUVQg=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "aA13428180880".to_string() // 用户设置的固定密码
    }
